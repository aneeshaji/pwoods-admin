      ...
      <div class="col-lg-12">
        <div class="card mb-4">
          <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
            <h6 class="m-0 font-weight-bold text-primary">Gallery - Add</h6>
          </div>
          <div class="card-body">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                <div class="custom-file">
                                    ...
                                    <input type="text" class="form-control" name="image_title" placeholder="Enter Image Title" required>
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                <div class="custom-file mt-32">
                                    <input type="file" class="custom-file-input" name="gallery_image" required>
